...
dataset = dataset.rename_column("development_day", "label")
...
# 保存训练集和测试集
dataset_save_path = '/mnt/data_sdb/wangx/data/organoid/kidney/split_datasets_development/'
...
# set output dir
output_dir='/mnt/data_sdb/wangx/GeneCompass/cell_anoatation/organoid/kidney/development/'
